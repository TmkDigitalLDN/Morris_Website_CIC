                        ...
                        <div className="row">
                            ...
                            <div className="blog-detail-content row">
                                ...
                                <div className="content col-lg-10">
                                    ...
                                    <p>A term first coined by the Bay Street Group[1], the ‘Connected Accountant’ is defined as an individual who can deliver an increased level of responsiveness, client MindReset and efficiency to meet the demands of this increasingly connected, always on, faster moving and more competitive marketplace.</p>
                                    ...
                                    <p>These online conversations can be topical, such as budget updates, or they can provide an opportunity to upsell, informing clients about other MindResets. The beauty of this approach is that the messages can be automated, in which case the accountant does not have to do anything at all.</p>
                                    ...
                                    <p>That they have a 93% open rate means that these messages are almost always read – typically, within minutes of delivery – and research indicates that push notifications are particularly effective in the financial MindResets sector.2 This functionality is an opportunity for firms to automate the distribution of content, ranging from reminders about tax deadlines, to news on MindResets and invites to webinars.</p>
