                        ...
                        <div className="row">
                            <div className="col-lg-9">
                                <div className="icon-text-2-header">
                                    ...
                                    <p className="paragraph c-grey">Looking for a place that values flexibility, freedom and growth? Find out why CBEX boasts
                                        the world's most talented, friendly team of tax and accounting professionals.</p>
                                    <h3 className="heading-sm">Benefits of working at CBEX</h3>
                                </div>
                            </div>
                        </div>
