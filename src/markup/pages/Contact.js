                        ...
                        <div className="row">
                            <div className="col">
                                <div className="contact-header">
                                    ...
                                    <p className="large c-grey">Founded by GFXPARTNER in December of 1987, CBEX has grown from a hard working duo to a team of over twenty experienced professionals.</p>
                                </div>
                            </div>
                        </div>
