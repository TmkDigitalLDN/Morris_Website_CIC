    ...
    const tab_content = [
        {
            ...
            content: (
                <>
                    ...
                    <p className="large c-grey">At CBEX, enjoy custom fixed price agreements tailored to your needs and face-to-face meetings with our experienced professionals. Then rest assured knowing that your work is reviewed by senior staff and that tax returns are always double-checked.</p>
                        ...
                        <div className="row">
                            <div className="col-lg-8">
                                <div className="intro-content">
                                    <h2>About CBEX</h2>
                                    <p className="paragraph-lg c-grey">Founded by GFXPARTNER in December of 1987, CBEX has grown from a hard working duo to a team of over twenty experienced professionals. The son of lifelong entrepreneurs have founded CBEX to help other business owners to be successful and in control.</p>
                                    <p className="paragraph-lg c-grey">At CBEX, enjoy custom fixed price agreements tailored to your needs and face-to-face meetings with our experienced professionals. Then rest assured knowing that your work is reviewed by senior staff and that tax returns are always double-checked.</p>
                            ...
                            <div className="col-lg-4">
                                <div className="vertical-txt-wrapper right-align">
                                    <h1 className="vertical-txt">CBEX</h1>
                                </div>
                            </div>
                        </div>
                    </div>
